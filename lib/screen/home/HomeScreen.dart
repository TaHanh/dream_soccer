...
import 'package:dreamsoccerclone/screen/drawer/DrawerScreen.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> _shareText() async {
    try {
      Share.text(
          'Dream League Soccer 2k20',
          'Dream League Soccer 2k20: https://play.google.com/store/apps/details?id=${applicationId}',
          'text/plain');
    } catch (e) {
      print('error: $e');
    }
